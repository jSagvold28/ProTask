local function createSubscription()
    ...
    repeat
        ...
        then
            ...
            print("ERROR: Invalid email address. Please use a proper TLD, if you don't know what a TLD is, please check tld.md")
        end
    until false
    ...
    local billingSelection = io.read()
    ...
    print("Billing Selection: " .. billingSelection)
    ...
    if input == "yes" then
        ...
        file:write("Billing selection: " .. billingSelection .. "\n")
