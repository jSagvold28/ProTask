...
local function addTask()
    ...
    io.write("Asignees: ")
    local asignees = io.read()

    io.write("Assignee Roles (what field does this apply to): ")
    local assigneeRoles = io.read()
    ...
    file:write("Asignees: " .. asignees .. "\n")
    file:write("Asignees roles: " .. assigneeRoles .. "\n")
